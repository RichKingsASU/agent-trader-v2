...
class ExecutionEngine:
    ...
    def __init__(
        ...
        *,
        ...
        # Best-effort reservation tracking (never raises on reserve/release).
    ...
    def execute_intent(self, *, intent: OrderIntent) -> ExecutionResult:
        ...
        try:
            # NOTE: We intentionally do not swallow exceptions (fail-closed). This try/except exists
            # only to ensure reservations are released on all exit paths.
            if True:
            ...
            try:
                ...
                if tenant_id:
                    ...
                    logger.warning(
                        "exec.idempotency_disabled missing_tenant_id client_intent_id=%s", intent.client_intent_id
                    )
            except Exception:

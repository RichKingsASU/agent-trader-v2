...
export interface UseMarketLiveQuotesOptions {
  subscribeQuotes?: boolean;
  subscribeHeartbeat?: boolean;
  heartbeatStaleAfterSeconds?: number;
}

export interface UseMarketLiveQuotesReturn {
  quotes: LiveQuote[];
...
export function useMarketLiveQuotes(options: UseMarketLiveQuotesOptions = {}): UseMarketLiveQuotesReturn {
  const {

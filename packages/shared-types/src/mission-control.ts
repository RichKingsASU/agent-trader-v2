 ...
 */
export type MissionControlEventV1 = PubSubEvent<
  "mission_control.event",
  1,
  MissionControlEventPayloadV1
>;

export type MissionControlAgentV1 = PubSubEvent<
  "mission_control.agent",
  1,
  MissionControlAgentPayloadV1
>;

export type MissionControlPubSubEventV1 =
